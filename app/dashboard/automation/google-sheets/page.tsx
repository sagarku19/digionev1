    ...
    <div className="space-y-6 w-full pb-16">
      ...
      <div className="flex items-center gap-4">
        <div className="w-12 h-12 bg-[var(--success-bg)] rounded-[var(--radius-lg)] flex items-center justify-center shrink-0">
          <Table2 className="w-6 h-6 text-[var(--success)]" />
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--radius-lg)] p-5">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-sm font-bold text-[var(--success)] hover:underline focus-visible:outline-none focus-visible:shadow-[var(--focus-ring)] rounded"
          >
            Open Google Sheets <ExternalLink className="w-3.5 h-3.5" />
          </a>
          <p className="text-xs text-[var(--text-tertiary)] mt-2">Make sure sharing is set to &quot;Anyone with the link can edit&quot;.</p>
        </div>
          ...
          <div className="space-y-2">
            {SYNC_OPTIONS.map(opt => (
              <button
                ...
                className={`w-full flex items-start gap-3 p-3.5 rounded-[var(--radius-md)] border-2 text-left transition-all focus-visible:outline-none focus-visible:shadow-[var(--focus-ring)] ${
              ...
              >
                <div className={`w-4 h-4 rounded border-2 flex items-center justify-center shrink-0 mt-0.5 transition-colors ${
                  selected.includes(opt.id) ? 'bg-[var(--success)] border-[var(--success)]' : 'border-[var(--border)]'
                }`}>

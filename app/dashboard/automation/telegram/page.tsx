  ...
  return (
    <div className="space-y-6 w-full pb-16">
      ...
      <div className="flex items-center gap-4">
        <div className="w-12 h-12 bg-[var(--info-bg)] rounded-[var(--radius-lg)] flex items-center justify-center shrink-0">
          <Send className="w-6 h-6 text-[var(--info)]" />
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--radius-lg)] p-5">
          ...
          <ol className="space-y-2 text-sm text-[var(--text-secondary)]">
            <li className="flex gap-2">
              <span className="font-bold text-[var(--info)] shrink-0">1.</span>
              Open Telegram and search for <span className="font-bold text-[var(--text-primary)]">@BotFather</span>
            </li>
            <li className="flex gap-2">
              <span className="font-bold text-[var(--info)] shrink-0">2.</span>
              Send <span className="font-mono bg-[var(--surface-muted)] px-1.5 py-0.5 rounded text-xs">/newbot</span> and follow the prompts
            </li>
            <li className="flex gap-2">
              <span className="font-bold text-[var(--info)] shrink-0">3.</span>
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--radius-lg)] p-5 space-y-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 bg-[var(--surface-muted)] border border-[var(--border)] rounded-[var(--radius-md)] px-3 py-2.5 focus-within:border-[var(--border-strong)] transition">
            ...
            <p className="text-xs text-[var(--text-tertiary)] mt-1.5">Add your bot as admin to the channel first, then paste the channel username or numeric ID.</p>
          </div>
        </div>
          ...
          <div className="space-y-2">
            {NOTIFY_EVENTS.map(ev => (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-[var(--radius-md)] border-2 text-left transition-all focus-visible:outline-none focus-visible:shadow-[var(--focus-ring)] ${
              ...
              >
                ...
                {events.includes(ev.id) && <Check className="w-4 h-4 text-[var(--info)] shrink-0" />}
              </button>
            ))}
          </div>
        </div>

        ...
        {Array.from({ length: total }, (_, i) => (
          <div
            ...
            className={`h-full flex-1 rounded-full transition-all duration-500 ease-out ${
              i < step ? 'bg-[var(--brand)]' : 'bg-[var(--border)]'
            }`}
          />
        ))}
      </div>
          ...
          {step === 1 && (
            <div className="space-y-6">
              <div className="text-center">
                <div className="w-10 h-10 bg-[var(--surface-muted)] rounded-[var(--radius-md)] flex items-center justify-center mx-auto mb-3 border border-[var(--border-subtle)]">
                  <LayoutTemplate className="w-5 h-5 text-[var(--text-secondary)]" />
                </div>
                <h2 className="text-base font-semibold text-[var(--text-primary)] mb-1">Pick a starting template</h2>
                <p className="text-sm text-[var(--text-secondary)] max-w-sm mx-auto">Don&apos;t overthink it — you can swap themes and customize everything later.</p>
              </div>
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <h2 className="text-base font-semibold text-[var(--text-primary)] mb-1">Name your store</h2>
                <p className="text-sm text-[var(--text-secondary)] max-w-sm mx-auto">This represents your main storefront. You can modify these later.</p>
              </div>
          ...
          {step === 3 && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-sm text-[var(--text-secondary)] max-w-sm mx-auto">Confirm your details and create the store.</p>
              </div>
          ...
          <div className="flex items-center justify-between mt-6 pt-4 border-t border-[var(--border-subtle)]">
            ...
            {step < 3 ? (
              <button
                onClick={() => setStep(s => s + 1)}
                disabled={!canNext()}
                className="group flex items-center gap-2 bg-[var(--brand)] hover:bg-[var(--brand-hover)] disabled:opacity-40 disabled:cursor-not-allowed text-[var(--text-on-brand)] px-3 py-2 rounded-[var(--radius-sm)] font-semibold text-sm focus-visible:outline-none focus-visible:shadow-[var(--focus-ring)] transition-colors"
              >
              ...
              <button
                ...
                disabled={submitting}
                className="group flex items-center justify-center gap-2 bg-[var(--accent)] hover:bg-[var(--accent-hover)] disabled:opacity-60 text-[var(--accent-fg)] px-4 py-2 rounded-[var(--radius-sm)] font-semibold text-sm focus-visible:outline-none focus-visible:shadow-[var(--focus-ring)] transition-colors"
              >

            ...
            <div className="space-y-6">
              <div className="text-center">
                <div className="w-10 h-10 bg-[var(--surface-muted)] rounded-[var(--radius-md)] flex items-center justify-center mx-auto mb-3 border border-[var(--border-subtle)]">
                  <AtSign className="w-5 h-5 text-[var(--text-secondary)]" />
                </div>
                <h2 className="text-base font-semibold text-[var(--text-primary)] mb-1">Claim your username</h2>
                <p className="text-sm text-[var(--text-secondary)] max-w-sm mx-auto">This is your global link — share it everywhere.</p>
              </div>
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <h2 className="text-base font-semibold text-[var(--text-primary)] mb-1">Set up your profile</h2>
                <p className="text-sm text-[var(--text-secondary)] max-w-sm mx-auto">This is what visitors see when they open your link.</p>
              </div>
          ...
          {step === 3 && (
            <div className="space-y-6">
              <div className="text-center">
                ...
                <h2 className="text-base font-semibold text-[var(--text-primary)] mb-1">Ready to go live?</h2>
                <p className="text-sm text-[var(--text-secondary)] max-w-sm mx-auto">Review your Link in Bio profile setup.</p>
              </div>

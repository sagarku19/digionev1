...
const INPUT = 'w-full px-5 py-3.5 bg-gray-50/50 dark:bg-zinc-900/50 border-2 border-gray-200 dark:border-zinc-800 rounded-2xl text-base font-medium focus:ring-0 focus:border-pink-500 outline-none text-[var(--text-primary)] placeholder-gray-400 transition-colors';
      ...
      <div className="w-full max-w-2xl mx-auto flex flex-col gap-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <button
            ...
            className="group inline-flex items-center gap-2 text-sm font-bold text-gray-600 dark:text-[var(--text-secondary)] hover:text-pink-600 dark:hover:text-pink-400 transition-colors bg-white/60 dark:bg-zinc-950/60 backdrop-blur-md px-4 py-2.5 rounded-xl border border-gray-200/50 dark:border-zinc-800/80 shadow-sm"
          >
          ...
          {step === 3 && (
            <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="rounded-[24px] border-2 border-pink-100 dark:border-pink-500/20 p-6 bg-pink-50/50 dark:bg-pink-500/5 relative overflow-hidden">
                ...
                {bio && <p className="mt-4 text-sm font-medium text-gray-600 dark:text-[var(--text-secondary)] leading-relaxed border-t border-pink-100 dark:border-zinc-800/80 pt-4 relative z-10 max-w-lg">{bio}</p>}
              </div>

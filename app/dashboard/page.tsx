  ...
  if (orders.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center px-4 opacity-70">
        ...
        <p className="text-sm font-bold text-gray-600 dark:text-gray-400">No orders yet</p>
...
// ─── Quick Actions ────────────────────────────────────────────
const QUICK_ACTIONS = [
  { label: 'Add Product',   href: '/dashboard/products/new',         icon: Package,    bg: 'bg-white dark:bg-zinc-900',  fg: 'text-gray-800 dark:text-gray-200'  },
  { label: 'Main Store',    href: '/dashboard/sites/new/store',      icon: Store,      bg: 'bg-indigo-50 dark:bg-indigo-500/10',  fg: 'text-indigo-600 dark:text-indigo-400'  },
  ...
  return (
    <div className="relative pt-6 pb-16 min-h-screen">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10">
        <div className="absolute top-[0%] left-[10%] w-[40%] h-[40%] bg-indigo-500/5 dark:bg-indigo-500/5 blur-[120px] rounded-full mix-blend-multiply dark:mix-blend-screen" />
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="xl:col-span-2 space-y-6 md:space-y-8">
            ...
            <div className="group bg-white/70 dark:bg-zinc-950/70 backdrop-blur-3xl border border-gray-200/80 dark:border-zinc-800/80 rounded-[32px] p-6 sm:p-8 shadow-sm hover:shadow-xl transition-all duration-300">
              <div className="flex items-start justify-between mb-8">
                <div>
                  <h2 className="text-lg font-extrabold text-gray-900 dark:text-white">Revenue</h2>
            ...
            <div className="bg-white/70 dark:bg-zinc-950/70 backdrop-blur-3xl border border-gray-200/80 dark:border-zinc-800/80 rounded-[32px] overflow-hidden shadow-sm">
              <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100 dark:border-zinc-800/50 bg-white/50 dark:bg-zinc-900/30">
                <h2 className="text-base font-extrabold text-gray-900 dark:text-white flex items-center gap-2">
                  <Package className="w-5 h-5 text-indigo-500" /> Top Performaing Products
                </h2>
              ...
              {productsLoading ? (
                ...
                <div className="flex flex-col items-center py-12 gap-3 opacity-80">
                  ...
                  <Link
                    ...
                    className="flex items-center gap-1.5 text-xs font-bold text-indigo-700 dark:text-indigo-300 bg-indigo-50 dark:bg-indigo-500/10 px-4 py-2 rounded-xl border border-indigo-100 dark:border-indigo-500/20 hover:bg-indigo-100 transition-colors"
                  >
                ...
                <div className="divide-y divide-gray-100 dark:divide-zinc-800/50">
                  {topProducts.map((p: any, idx: number) => (
                    ...
                    >
                      ...
                      <div className="w-8 h-8 rounded-full bg-gray-50 dark:bg-zinc-900 flex items-center justify-center group-hover:bg-indigo-50 dark:group-hover:bg-indigo-500/10 transition-colors border border-transparent group-hover:border-indigo-100 dark:group-hover:border-indigo-500/20">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="bg-white/70 dark:bg-zinc-950/70 backdrop-blur-3xl border border-gray-200/80 dark:border-zinc-800/80 rounded-[32px] overflow-hidden shadow-sm">
              <div className="flex items-center justify-between px-5 py-5 border-b border-gray-100 dark:border-zinc-800/50 bg-white/50 dark:bg-zinc-900/30">
                <div className="flex items-center gap-3">
                  <h2 className="text-base font-extrabold text-gray-900 dark:text-white inline-flex items-center gap-2">
                ...
                <Link href="/dashboard/earnings" className="text-xs font-bold text-gray-400 hover:text-gray-900 dark:hover:text-white transition bg-gray-50 dark:bg-zinc-900 px-3 py-1.5 rounded-xl border border-gray-200 dark:border-zinc-800">
                  View All
                </Link>
              </div>
            ...
            <div className="bg-white/70 dark:bg-zinc-950/70 backdrop-blur-3xl border border-gray-200/80 dark:border-zinc-800/80 rounded-[32px] p-6 shadow-sm">
              <h2 className="text-base font-extrabold text-gray-900 dark:text-white mb-5 flex items-center gap-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                {QUICK_ACTIONS.map(a => (
                  ...
                  >
                    ...
                    <span className="text-[11px] font-bold text-gray-600 dark:text-gray-400 text-center leading-tight group-hover:text-gray-900 dark:group-hover:text-white transition-colors">
                      {a.label}
                    </span>
                  </Link>
                ))}

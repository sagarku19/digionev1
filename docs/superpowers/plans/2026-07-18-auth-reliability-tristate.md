...
- [ ] **Step 3:** `.claude/todo-later/17(left)-2026-07-17-auth-refresh-cadence.md` — record: diagnosis kit shipped (`lib/supabase/auth-debug.ts`, enable `localStorage['digione.auth.debug']='1'`, dump `window.__authDebug()`), and the decision tree from the spec §5.

...
<span style="display:inline-flex;align-items:center;gap:8px;margin-bottom:28px">${linkMark}<span style="font-family:'Succulent',cursive;font-size:30px;line-height:1;color:#16130F">${brand}<span style="color:#E83A2E">.${tld}</span></span></span>

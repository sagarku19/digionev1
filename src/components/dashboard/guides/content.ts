...
export const GUIDES: Record<GuideKey, Guide> = {
  ...
  links: {
    ...
    home: 'Short Links',
    steps: [
      { title: 'Create a link', desc: 'Click Create link, paste the destination URL, and give it a short, memorable code.', icon: Link2 },
      { title: 'Pick a code', desc: 'Type your own code and we check availability live, or let one be generated for you.', icon: Hash },
      { title: 'Add rules (optional)', desc: 'Optionally set an expiry date, a max-click limit, geo or device targeting, or a password gate.', icon: Clock },
      { title: 'Share it', desc: 'Copy the short link and share it anywhere — bio, posts, email, or DMs.', icon: Share2 },

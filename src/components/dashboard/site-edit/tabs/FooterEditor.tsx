    ...
    <div className="space-y-6">
      ...
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--radius-lg)] p-5 space-y-4">
        <div>
          ...
          <p className="text-xs text-[var(--text-secondary)] mt-0.5">Shown in your site footer and about section</p>
        </div>
        {(['instagram', 'youtube', 'twitter', 'linkedin'] as const).map(platform => (
          <div key={platform}>
            <label className="block text-xs font-medium text-[var(--text-secondary)] mb-1.5 capitalize">{platform}</label>
      ...
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--radius-lg)] p-5 space-y-4">
        <div>
          ...
          <p className="text-xs text-[var(--text-secondary)] mt-0.5">Enable these to show links in your site footer</p>
        </div>
        {[
          ...
          <div key={key}
            className="flex items-center justify-between px-4 py-3.5 bg-[var(--surface-muted)] rounded-[var(--radius-md)] border border-[var(--border)] hover:border-[var(--border-strong)] transition">
            <div>
      ...
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--radius-lg)] p-5 space-y-4">
        <div>
          ...
          <p className="text-xs text-[var(--text-secondary)] mt-0.5">Displayed in your footer for customer inquiries</p>
        </div>
        <div>
      ...
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-[var(--radius-lg)] p-5 space-y-4">
        <div>
          ...
          <p className="text-xs text-[var(--text-secondary)] mt-0.5">Footer bottom text (leave empty for default)</p>
        </div>

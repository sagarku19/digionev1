...
const MockStore = () => (
  <div className="w-full max-w-[180px] rounded-lg border border-black/[0.08] bg-white overflow-hidden shadow-[0_2px_12px_-4px_rgba(22,19,15,0.10)]">
    <div className="flex items-center gap-1.5 px-2.5 py-1.5 border-b border-black/[0.06]">
    ...
    <div className="p-2 grid grid-cols-2 gap-1.5">
      {[0, 1, 2, 3].map((n) => (
        <div key={n} className="rounded-md border border-black/[0.06] p-1.5">
          <div className={`h-6 rounded-sm mb-1 ${n === 0 ? 'bg-[#E83A2E]/80' : 'bg-black/[0.07]'}`} />
          <div className="h-1 w-3/4 rounded-full bg-black/[0.12] mb-1" />
...
const MockSingle = () => (
  <div className="w-full max-w-[180px] rounded-lg border border-black/[0.08] bg-white overflow-hidden shadow-[0_2px_12px_-4px_rgba(22,19,15,0.10)]">
    <div className="h-12 bg-[#16130F] relative">
...
const MockPayment = () => (
  <div className="w-full max-w-[180px] rounded-lg border border-black/[0.08] bg-white overflow-hidden shadow-[0_2px_12px_-4px_rgba(22,19,15,0.10)] p-2.5">
    <div className="h-1.5 w-20 rounded-full bg-black/[0.15] mb-2.5" />
    <div className="rounded-md border border-black/[0.1] px-2 py-1.5 mb-1.5 flex items-center gap-1">
    ...
    <div className="rounded-md border border-black/[0.06] px-2 py-1.5 mb-2">
      <div className="h-1 w-2/3 rounded-full bg-black/[0.1]" />
    </div>
    <div className="h-5 rounded-md bg-[#E83A2E] flex items-center justify-center">
...
const MockLinkInBio = () => (
  <div className="w-full max-w-[150px] rounded-lg border border-black/[0.08] bg-white overflow-hidden shadow-[0_2px_12px_-4px_rgba(22,19,15,0.10)] p-2.5 flex flex-col items-center">
    <div className="w-7 h-7 rounded-full bg-[#16130F] mb-1.5 flex items-center justify-center">
      <span className="font-ledger text-[9px] font-medium text-white">A</span>
    </div>
    <div className="h-1 w-12 rounded-full bg-black/[0.2] mb-2.5" />
    <div className="w-full space-y-1.5">
      <div className="h-4 rounded-md bg-[#E83A2E]" />
      <div className="h-4 rounded-md border border-black/[0.1]" />
      <div className="h-4 rounded-md border border-black/[0.1]" />
    </div>
  </div>
);

  ...
  return (
    <section className="py-12 sm:py-20 lg:py-28 bg-white relative overflow-hidden pb-0">
      ...
      <div className="relative w-full px-5 sm:px-8 text-center z-10 flex flex-col h-full">
        <InView>
          <div className="iv max-w-4xl mx-auto flex flex-col items-center mb-10 sm:mb-16 lg:mb-24 px-2 sm:px-0">
            ...
            <h2 className="text-[28px] sm:text-[44px] md:text-[60px] lg:text-[72px] font-black text-gray-900 tracking-[-0.04em] leading-[1.05] mb-4 sm:mb-6 max-w-3xl mx-auto drop-shadow-sm">
              Start selling
              <br />
              <span
                style={{
            ...
            <p className="text-[14px] sm:text-[17px] lg:text-[19px] text-gray-500 font-medium leading-relaxed mb-6 sm:mb-10 max-w-md mx-auto px-4 sm:px-0">

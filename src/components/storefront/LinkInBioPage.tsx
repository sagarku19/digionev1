...
function LinkCard({
  ...
  // ── Lead Form (dynamic fields) ──
  if (link.link_type === 'lead_form' || link.link_type === 'email_capture') {
    return <LeadFormBlock link={link} bio={bio} palette={palette} siteId={siteId} animStyle={animStyle} getRadiusClass={getRadiusClass} />;
  }

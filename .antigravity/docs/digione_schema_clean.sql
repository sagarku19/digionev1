...
DO $$ BEGIN CREATE TYPE storage_provider_type AS ENUM (
    'supabase','digitalocean','aws_s3','cloudflare_r2','gcs','bunny'
); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
CREATE TABLE IF NOT EXISTS public.sites (
    ...
    CONSTRAINT chk_sites_parent_slug_consistency CHECK (
     ...
     OR (site_type != 'main' AND child_slug IS NOT NULL AND parent_site_id IS NOT NULL AND slug IS NULL)
    )
);
...
CREATE TABLE IF NOT EXISTS public.notifications (
    ...
    type                 text NOT NULL CHECK (type IN ('sale','refund','payout','review','kyc_reminder','kyc_rejected','order','wallet')),
...
DO $$ BEGIN
  ...
  ALTER TABLE public.media_library ADD CONSTRAINT fk_media_library_storage FOREIGN KEY (storage_file_id) REFERENCES public.storage_files(id) ON DELETE SET NULL;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN
  -- Sites
  ALTER TABLE public.sites      ADD CONSTRAINT fk_sites_creator  FOREIGN KEY (creator_id) REFERENCES public.profiles(id) ON DELETE CASCADE;
...
DO $$ BEGIN
  ALTER TABLE public.site_singlepage ADD CONSTRAINT fk_sp_site    FOREIGN KEY (site_id)    REFERENCES public.sites(id)    ON DELETE CASCADE;
  ALTER TABLE public.site_singlepage ADD CONSTRAINT fk_sp_product FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE RESTRICT;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN
  ...
  ALTER TABLE public.blog_posts ADD CONSTRAINT fk_blog_posts_creator FOREIGN KEY (creator_id) REFERENCES public.profiles(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN
  -- Products
  ALTER TABLE public.products ADD CONSTRAINT fk_products_creator FOREIGN KEY (creator_id) REFERENCES public.profiles(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN
  ...
  ALTER TABLE public.product_files ADD CONSTRAINT fk_pf_storage FOREIGN KEY (storage_file_id) REFERENCES public.storage_files(id) ON DELETE SET NULL;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN
  -- Orders
  ALTER TABLE public.order_items ADD CONSTRAINT fk_oi_order   FOREIGN KEY (order_id)   REFERENCES public.orders(id)   ON DELETE CASCADE;
  ALTER TABLE public.order_items ADD CONSTRAINT fk_oi_product FOREIGN KEY (product_id) REFERENCES public.products(id) ON DELETE SET NULL;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN
  -- Subscriptions
  ALTER TABLE public.subscriptions ADD CONSTRAINT fk_sub_creator FOREIGN KEY (creator_id)          REFERENCES public.profiles(id)          ON DELETE CASCADE;
  ALTER TABLE public.subscriptions ADD CONSTRAINT fk_sub_plan    FOREIGN KEY (subscription_plan_id) REFERENCES public.subscription_plans(id);
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN
  -- Payouts
  ALTER TABLE public.creator_payout_request_items ADD CONSTRAINT fk_cpri_request FOREIGN KEY (payout_request_id) REFERENCES public.creator_payout_requests(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN
  -- Visual builder
  ALTER TABLE public.page_blocks     ADD CONSTRAINT fk_pb_page     FOREIGN KEY (page_id)        REFERENCES public.pages(id)         ON DELETE CASCADE;
  ALTER TABLE public.page_block_media ADD CONSTRAINT fk_pbm_block  FOREIGN KEY (page_block_id)  REFERENCES public.page_blocks(id)   ON DELETE CASCADE;
  ALTER TABLE public.page_block_media ADD CONSTRAINT fk_pbm_media  FOREIGN KEY (media_id)        REFERENCES public.media_library(id) ON DELETE CASCADE;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN
  ...
  ALTER TABLE public.builder_assets ADD CONSTRAINT fk_ba_storage FOREIGN KEY (storage_file_id) REFERENCES public.storage_files(id) ON DELETE SET NULL;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
CREATE INDEX IF NOT EXISTS idx_media_library_storage_file ON public.media_library (storage_file_id) WHERE storage_file_id IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_products_discover          ON public.products (is_on_discover_page, created_at DESC) WHERE is_on_discover_page = true;
...
CREATE INDEX IF NOT EXISTS idx_product_files_storage     ON public.product_files (storage_file_id) WHERE storage_file_id IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_orders_guest_lead         ON public.orders (guest_lead_id) WHERE guest_lead_id IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_tl_order   ON public.transaction_ledger (order_id) WHERE order_id IS NOT NULL;

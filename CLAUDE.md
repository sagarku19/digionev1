...
| `docs/reference/admin-dashboard.md` | Touching anything super_admin (`app/dashboard/admin/**`, `/api/admin/**`, refund requests, payout queue) — the complete admin surface + auth/money invariants + the plan to move admin to a standalone app |
